...
<div class="middle">
    <div class="reserveDiv">
        <form action="${pageContext.request.contextPath}/front/book.do" method="post" class="reserveForm">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/front/renewBook.js"></script>
