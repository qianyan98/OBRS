...
<div class="sendEmail">
    <form action="" method="post" class="sendEmailForm">

        <p><label for="emailTitle">主&nbsp;&nbsp;&nbsp;&nbsp;题</label> <input type="text" name="title" id="emailTitle"><span></span></p>

        <p><label for="sendTo">收件人</label> <input type="text" name="sendTo" id="sendTo" value="${sendTo}"><span></span></p>

        <p>发件人 <input type="text" name="sendFrom" class="sendFrom" disabled style="background: white; width: 600px" value="${sendFrom}"></p>

        <div class="toolBar1">
            <ul class="toolBarList">
                <li>
                    <select name="formatting" id="formatting" onchange="formatDoc('formatblock', this[this.selectedIndex].value); this.selectedIndex=0;">
                ...
                <li>
                    <select name="font" id="font" onchange="formatDoc('fontname', this[this.selectedIndex].value); this.selectedIndex=0;">
                ...
                <li>
                    <select name="size" id="size" onchange="formatDoc('fontsize', this[this.selectedIndex].value); this.selectedIndex=0;">
                ...
                <li>
                    <select name="color" id="color" onchange="formatDoc('forecolor', this[this.selectedIndex].value); this.selectedIndex=0;">
                ...
                <li>
                    <select name="background" id="background" onchange="formatDoc('backcolor',this[this.selectedIndex].value);this.selectedIndex=0;">
        ...
        <div class="toolBar2">
            <img class="intLink" title="Clean" onclick="if(confirm('Are you sure?')){doc.html('')}" src="data:image/gif;base64," />
        ...
        <p class="emailContentTip">正&nbsp;&nbsp;&nbsp;&nbsp;文</p>
        <div id="textBox" contenteditable="true">

        </div>
        <p>
            <input type="button" value="发送" style="width: 80px; height: 30px; margin-left: 330px; margin-top: 10px" id="sendEmailBtn">
            <span id="sendOutcome" style="margin-left: 5px"></span>
        </p>
    </form>
</div>

<script type="application/javascript" src="${pageContext.request.contextPath}/statics/js/background/richTextEditor.js"></script>