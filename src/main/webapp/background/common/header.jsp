...
<div class="head">
    <div class="head-container">
        <a href="${pageContext.request.contextPath}/background/frame.jsp">
            <span class="logo">OBRS</span>
        </a>
        <span class="welcomeTip">${sessionScope.USER_SESSION.userName}管理员你好, 欢迎进入OBRS</span>
        <div class="logoutBtn">
            <button type="button" name="logout"><a href="${pageContext.request.contextPath}/background/logout.do">注销</a></button>
        </div>
    </div>
</div>
