...
public interface BookDao {
    ...
    //获取所有的预约记录
    List<ReserveDto> getAllReserve(String userName, String reserveId, Date endDate1, Date endDate2, int pageIndex, int pageSize);
    //获取预约的数目
    int getReserveCount(String userName, String reserveId, Date endDate1, Date endDate2);
    //根据id获取预约记录
